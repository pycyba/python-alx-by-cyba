...
# Napisy są "niemutowalne" (immutable), czyli nie da się zmienić zawartości obiektu typu str.
...
# dla porównania list są mutowalne (mutable)
# zmienne lista_a i lista_b wskazują na ten sam obiekt
lista_a = ['Ala', 'kot']
lista_b = lista_a
print(lista_a, lista_b)
lista_a += ['pies']
print(lista_a, lista_b)
lista_a.append('chomik')
print(lista_a, lista_b)
print()
...
print(napis)
podzial = napis.split()
print(podzial, 'typu', type(podzial))

napis = 'Katowice;Warszawa Centralna;Gdańsk Główny'
podzial = napis.split(';')
print(podzial)
print()
...
napis = ';'.join(lista_a)
print(napis)
print('Witamy osoby ' + ' oraz '.join(lista_a) + ".")
