...
# Z kolei gdy chcemy zastosować jakąś funkcję ,np. podnoszenie do kwadratu, dla każdego elementu listy,
# to możemy:
...
# To staje się ładniejsze w zapisie, gdy mamy funkcję, której chcemy użyć
