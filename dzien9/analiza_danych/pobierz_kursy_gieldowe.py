...
# te importy nie są potrzebne do działania programu, ale wpisuję, abyście sobie kliknęli i zainstlaowali w PyCharm
# import openpyxl
# import matplotlib

ticker = input('Podaj symbol, np. pkn , wig20 albo usdpln: ')
...
miesiace = df.resample('ME').agg(agregaty)
