...
# Umieszczenie testów w klasie daje nowe możliwości,
# np. można napisać metodę `setup_method`, która będzie wykonywana przed każdym testem
# To przypomina działania biblioteki JUnit z języka Java.
...
class TestEmployee:
    ...
    def setup_method(self, method):
        ...
        self.emp = Pracownik('Jan', 'Nowak', 100.0)
