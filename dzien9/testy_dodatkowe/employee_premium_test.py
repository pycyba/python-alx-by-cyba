...
from klasa_pracownik import PremiumPracownik

# Teraz dla obiektu PremiumEmployee - jak go tworzymy w setup_method - zostaná wykonane także testy odziedziczone z TestEmployee
...
class TestPremiumEmployee(TestEmployee):
    def setup_method(self, method):
        ...
        self.emp = PremiumPracownik('Jan', 'Nowak', 100.0)
