# Zmienna definiowana na poziomie pliku, poza jakąkolwiek funkcją czy klasą, to jest "zmienna globalna"

# Także gdy jest w jakimś if-e, try-u itp.
if 5 > 0:
    globalna = 100

print(globalna, "na początku pliku")
...
def aaa(a):
    ...
    # gdy definiujemy funkcję zagnieżdżoną, to jest dostęp do lokalnych funkcji zewnętrznej
    def inna2():
        print('inna2', lokalna)
...
def bbb(a):
    ...
    print('globals:', globals())
    print('locals:', locals())
    print('globalna ze słownika:', globals()['globalna'])
    print('koniec bbb')
...
def ddd():
    ...
    # to musimy ją zadeklarować pisząc global
    global globalna
