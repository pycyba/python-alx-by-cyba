...
# 2) Podczas wywołania parametry można też przekazywać po nazwie
# 'keyword argument'
aaa(a='Alicja', b='Barbara', c='Czesław')
# aaa(a='Alicja', c='Czesław')
# aaa(a='Alicja', b='Bartek', c='Czesław', b='Bartek')
# aaa(a='Alicja', b='Bartek', c='Czesław', x='Dodatkowy')
...
# gdy użyjemy innego typu, to PyCharm wyświetli warning, ale Python zaakceptuje
bbb('ala', 'baba', 12, e=13)

# teraz przekazujemy wprost wartość None - to nie jest to samo,
# co wywołanie bez parametru
bbb('Agata', 'Bartek', c=None, d='Dzidzia')
...
eee('Ala', 'Basia', 'Cukierek', 'Dzięcioł', c='Cezary')

# tutaj Ala i Basia są przekazane jako "positional arguments"
...
# Z kolei symbol / oznacza, że po jego LEWEJ stronie są parametry,
# które mogą być przekazywane tylko jako pozycyjne. Nie mogą być przez nazwę.
def lll(a, b, /, c, d):
    print(f'lll: a={a}, b={b}, c={c}, d={d}')
...
def mmm(a, b, /, *, c, d):
    print(f'mmm: a={a}, b={b}, c={c}, d={d}')

# W takim razie tu mamy ściśle określone najpierw parametry pozycyjne, później nazwowe
mmm(11, 22, c=33, d=44)
# mmm(11, b=22, c=33, d=44)
# mmm(11, 22, 33, d=44)
...
def ggg(**kwargs):
    print('ggg: kwargs =', kwargs)
    print(f'    typem kwargs jest {type(kwargs)}')
    if 'a' in kwargs:
        print('parametr a =', kwargs['a'])
    print()
...
# ggg(a='Ala', k='Kasia', x=113, a='Alicja')
ggg()
print()
...
# wszystkie nadmiarowe parametry pozycyjne trafiają do *args
hhh('Ala', 'Basia', 'Celina', 'Dorota', 'Ela', 'Felicja')

# wszystkie nadmiarowe parametry nazwane trafiają do **kwargs
...
def iiii(a, b, c, d):
    print(f'iiii: a={a}, b={b}, c={c}, d={d}')

# te trzy wywołania dają ten sam efekt:
# iiii(lista) - źle, bo teraz lista byłaby wartością samego parametru a
iiii(*lista)
iiii(lista[0], lista[1], lista[2], lista[3])
iiii('Alicja', 'Barbara', 'Celina', 'Dagmara')
print()
...
# raczej nie o to chodzi - do a będzie wpisana cała lista
jjj(lista, 'bum', 'cyk')

# abcd wzięte z listy, a e='ostatni'
jjj(*lista, 'ostatni')

# a='Ala', a reszta z listy
jjj('Ala', *lista)
print()
